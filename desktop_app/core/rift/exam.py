...
CHUNIN_STAGE_META = [
    {
        ...
        "label": "Stage 1",
        "timer_range": (45, 60),
        "finish_builder": lambda session_key, char_id, stage_id: [
            session_key,
            char_id,
            stage_id,
            True,
...
JOUNIN_STAGE_META = [
    {
        ...
        "label": "Stage 1",
        "timer_range": (300, 600),
        "finish_builder": lambda session_key, char_id, stage_id: [session_key, char_id, stage_id, 6, 0],
    },
    {
        "id": 2,
        "label": "Stage 2",
        "timer_range": (300, 1800),
        "finish_builder": lambda session_key, char_id, stage_id: [session_key, char_id, stage_id, True, True, True, True],
    },
    {
        "id": 3,
        "label": "Stage 3",
    ...
    },
    {
        ...
        "finish_builder": lambda session_key, char_id, stage_id: [session_key, char_id, stage_id],
    },
    {
        "id": 5,
        "label": "Stage 5",
...
TUTOR_STAGE_META = [
    {"id": 1, "start_id": 1, "label": "Stage 1 Chapter 1", "stage_key": "stage1-1", "timer_range": (180, 360)},
    {"id": 2, "start_id": 2, "label": "Stage 1 Chapter 2", "stage_key": "stage1-2", "timer_range": (1200, 2400)},
    {"id": 3, "start_id": 3, "label": "Stage 2 Chapter 1", "stage_key": "stage2-1", "timer_range": (90, 180)},
    {"id": 4, "start_id": 4, "label": "Stage 2 Chapter 2", "stage_key": "stage2-2", "timer_range": (900, 1800)},
    {"id": 5, "start_id": 5, "label": "Stage 3 Chapter 1", "stage_key": "stage3-1", "timer_range": (450, 900)},
    {"id": 6, "start_id": 6, "label": "Stage 3 Chapter 2", "stage_key": "stage3-2", "timer_range": (600, 1200)},
    {"id": 7, "start_id": 7, "label": "Stage 4 Chapter 1", "stage_key": "stage4-1", "timer_range": (450, 900)},
    {"id": 8, "start_id": 8, "label": "Stage 4 Chapter 2", "stage_key": "stage4-2", "timer_range": (600, 1200)},
    {"id": 9, "start_id": 9, "label": "Stage 5 Chapter 1", "stage_key": "stage5-1", "timer_range": (450, 900)},
    {"id": 10, "start_id": 10, "label": "Stage 5 Chapter 2", "stage_key": "stage5-2", "timer_range": (600, 1200)},
    {"id": 11, "start_id": 11, "label": "Stage 6 Chapter 1", "stage_key": "stage6-1", "timer_range": (1500, 3000)},
    {"id": 12, "start_id": 12, "label": "Stage 6 Chapter 2", "stage_key": "stage6-2", "timer_range": (900, 1800)},
]

for stage in TUTOR_STAGE_META:
    stage["finish_builder"] = (
        lambda session_key, char_id, stage_id, _stage=stage: [char_id, session_key, _stage["id"], []]
    )
...
def _promote_exam(level_gate: int):
    ...
    if params_order == "char_session":
        ...
        selected_skill = _cfg_text("rift_special_jounin_class_skill", "skill_2002")
...
def _finish_stage(level_gate: int, stage_meta: dict):
    ...
    char_id = get_char_id()
    session_key = get_session_key()
    params = stage_meta["finish_builder"](session_key, char_id, stage_meta["id"])
    return send_rift_request(f"{cfg['prefix']}.finishStage", params)
